...
import { Ticket, LogIn, Film, Clapperboard } from "lucide-react";
          ...
          <div className="space-y-4 relative z-10">
            ...
            <div className="space-y-2">
              ...
              <Input 
                ...
                className="border-primary/50 focus:ring-primary bg-input 
                  font-mono text-foreground tracking-wider"
                value={email}
            ...
            <div className="text-center text-xs text-muted-foreground italic">
              <p>Hint: Use email: cinema@example.com</p>
              <p>Password: CinemaPrompt2024!</p>
            </div>
          </div>
